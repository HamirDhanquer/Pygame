...
def score_display( game_state ):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center = (288,590))
...
#pygame.mixer.pre_init(frequency=44100, size=16, channels=2, buffer=0)
pygame.init()
...
game_over_rect = game_over_surface.get_rect( center = (288,312) )
